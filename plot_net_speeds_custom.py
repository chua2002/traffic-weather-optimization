...
def main(args=None):
    ...
    ap.add_argument("--scenario", dest="SCENARIO", category="input",
                    required=True, help="scenario name")
    ap.add_argument("--weather", dest="WEATHER", category="input",
                    required=True, help="weather name")
    ...
    minV = None
    maxV = None
    for e, s in zip(net._id2edge, best_speeds):
        v = s
